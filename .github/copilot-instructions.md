# AI Donor Matcher — Backend Copilot Instructions
...
## Skills
Project-specific skills are in `docs/skills/`. Each skill has a `SKILL.md` with instructions for implementing that area of the codebase.
